...
const play_music = (track, pause = false) => {
    current_song.src = `https://manishkumarbingi.github.io/spotify/${currfolder}/` + track + ".mp3";
    if (!pause) {
        current_song.play();
...
async function display_albums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs/")) {
            ...
            let a = await fetch(`https://manishkumarbingi.github.io/spotify/songs/${folder}/info.json`);
           ...
           <img src="https://manishkumarbingi.github.io/spotify/songs/${folder}/cover.jpg" alt="">
    ...
    //attach an event listener for next and previous buttons
